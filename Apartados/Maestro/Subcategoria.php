        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Sección Subcategoria</h1>
                        </div>
                        <!-- /.col -->
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background-color:#3f668d">
                                                    <h5 class="modal-title" style="color:white" id="exampleModalLabel">Ingreso de subcategoría</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="../../PhP/INSERTAR_subcategoria.php">
                                                        <h4 style="font-size:20px;font-weight:bold;margin:auto;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #00c0ef;">
                                                            Datos de la Subcategoría</h4>
                                                        <div class="form-row">

                                                            <div class="form-group col-md-6">
                                                                <label for="inputSubcategoría">Nombre:</label>
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text"><i class="fas fa-building"></i>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="subcategoria" id="subcategoria" placeholder="Ingrese el nombre de la subcategoría">
                                                                </div>

                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="inputSubcategoría">Categoría:</label>
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text"><i class="fas fa-building"></i>
                                                                    </div>
                            ...
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        // Agregar categoría al cuadro hacer la consulta
                                        $resultado = mysqli_query($conn, $sql);
                                        while ($filas = mysqli_fetch_array($resultado)) {
                                            $var = $filas['id_subcategoria'];
                                            $sql2 = "SELECT * FROM categoria WHERE id_Categoria=(SELECT id_Categoria FROM subcategoria)";
                                            $resultado2 = mysqli_query($conn, $sql2);
                                            $categorias = mysqli_fetch_array($resultado2);

                                        ?>
                                            <tr>

                                                <td><?php echo $filas['NombreSubcategoria'] ?></td>
                                                <td><?php echo $categorias['Nombre'] ?></td>

                                                <!-- Consulta para tener el telefono del empleado y el nombre de la comuna -->

                                                <td>
                                                    <a href="../../CRUD/DELETE_subcategoria.php?id=<?php echo $filas['id_subcategoria'] ?>"><button type="button" class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
                                                    <button type="button" class="btn btn-primary editbtn" data-toggle="modal" data-target="#update_service<?php echo $filas['id_subcategoria']; ?>"><i class="fas fa-edit"></i></button>
                                                </td>
                                            </tr>
                                        <?php
